...
const Body = () => {
  ...
  const fetchData = async () => {
    try {
      const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.469189&lng=77.1313681&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"  );
